...
export async function getPostsWithComments() {
  try {
    ...
    const { data } =await axios.get(
      `https://plantcareapi.runasp.net/api/Community/get-posts-with-comments`,
      {
        headers: {
...
export const addPosts = async (values) => {
  try {
    ...
    const response = axios.post(
      `https://plantcareapi.runasp.net/api/Community/add-post`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const addComment = async (values) => {
  try {
    ...
    const response = axios.post(
      `https://plantcareapi.runasp.net/api/Community/add-comment`,
      values,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
console.log("Token:", token); // Add this line
    const response = await axios.post(
      `https://plantcareapi.runasp.net/api/Community/add-like/${id}`,
    {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const addDisLike = async ( id) => {
  try {
    ...
    const token = localStorage.getItem("userToken");
    const response = await axios.post(
      `https://plantcareapi.runasp.net/api/Community/add-dislike/${id}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const removeReactionApi = async ( id) => {
  try {
    ...
    const token = localStorage.getItem("userToken");
    const response = await axios.post(
      `https://plantcareapi.runasp.net/api/Community/delete-reaction/${id}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const EditPost = async (values, id) => {
  try {
    ...
    const response = await axios.put(
      `https://plantcareapi.runasp.net/api/Community/edit-post/${id}`,
      values,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const EditComment = async (values, id) => {
  try {
    ...
    const token = localStorage.getItem("userToken");
    const response = await axios.put(
      `https://plantcareapi.runasp.net/api/Community/edit-comment/${id}`,
      values,
      {
        headers: {
          Authorization: `Bearer ${token}`,
...
export const deletePost = async (id) => {
  try {
    ...
    const response = await axios.delete(
      `https://plantcareapi.runasp.net/api/Community/delete-post/${id}`,
...
export const deleteComment = async (id) => {
  try {
    ...
    const response = await axios.delete(
      `https://plantcareapi.runasp.net/api/Community/delete-comment/${id}`,
