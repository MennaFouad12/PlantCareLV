...
export async function getWorkShop() {
  try {
    ...
    const { data } = await axios.get(
      `https://plantcareapi.runasp.net/api/WorkShop/GetAllWorkshopsForAdmin`,
      {
        headers: {
...
export const addWorkShop = async (formData) => {
  try {
    ...
    const response = await axios.post(
      `https://plantcareapi.runasp.net/api/WorkShop/AddWorkshop`,
...
export const updateWorkShop = async (id, formData) => {
  try {
    ...
    const response = await axios.put(
      `https://plantcareapi.runasp.net/api/WorkShop/UpdateWorkshop/${id}`,
...
export const deleteWorkShop = async (id) => {
  try {
    ...
    const response = await axios.delete(
      `https://plantcareapi.runasp.net/api/WorkShop/RemoveWorkshop/${id}`,
      //   `http://plantcareapi.runasp.net/api/Blog/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
