...
function AdminManagement() {
  ...
  const { data: admins, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await axios.get(`https://plantcareapi.runasp.net/api/Admin/get-admins`, {
        headers: {
  ...
  const addAdminMutation = useMutation({
    mutationFn: async (admin) => {
      ...
      const response = await axios.post(
        'https://plantcareapi.runasp.net/api/Admin/add-admin',
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const editAdminMutation = useMutation({
    mutationFn: async ({ id, admin }) => {
      ...
      const response = await axios.put(
        `https://plantcareapi.runasp.net/api/Admin/edit-admin/${id}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deleteAdminMutation = useMutation({
    mutationFn: (id) => {
      const token = localStorage.getItem('userToken');
      return axios.delete(`https://plantcareapi.runasp.net/api/Admin/delete-admin/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
